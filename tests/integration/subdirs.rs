...
crate::subdir_test_variants! {
    ...
    repo.autter(&["checkpoint"]).unwrap(); // Human checkpoint for LICENSE
...
crate::subdir_test_variants! {
    ...
    repo.autter(&["checkpoint", "mock_ai", "a/b/c/deep.rs"]).unwrap();
