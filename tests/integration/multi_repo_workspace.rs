...
//!
//! This test module verifies that autter correctly handles workspaces that contain
...
fn create_unique_tmp_dir(prefix: &str) -> Result<PathBuf, AutterError> {
    ...
    for _attempt in 0..100u32 {
        ...
        match fs::create_dir(&path) {
            ...
            Err(e) => return Err(AutterError::IoError(e)),
        }
    }
...
fn init_git_repo(path: &PathBuf) -> Result<(), AutterError> {
    ...
    let output = Command::new("git")
        ...
        .args(["init"])
        .output()
        .map_err(|e| AutterError::Generic(format!("Failed to run git init: {}", e)))?;
...
fn create_file(path: &PathBuf, content: &str) -> Result<(), AutterError> {
...
fn test_find_repository_for_file_basic() {
    ...
    let workspace = create_unique_tmp_dir("autter-multi-repo-test").unwrap();
...
fn test_nonexistent_file_path() {
    ...
    let workspace = create_unique_tmp_dir("autter-nonexistent-test").unwrap();
...
fn test_all_files_orphaned() {
    ...
    let workspace = create_unique_tmp_dir("autter-all-orphans-test").unwrap();
...
fn test_single_repo_in_multi_repo_workspace() {
    ...
    let workspace = create_unique_tmp_dir("autter-single-edit-test").unwrap();
...
fn test_files_with_spaces_in_path() {
    ...
    let workspace = create_unique_tmp_dir("autter-spaces-test").unwrap();
...
fn test_symlinked_repository() {
    ...
    let workspace = create_unique_tmp_dir("autter-symlink-test").unwrap();
...
fn test_bare_repository_handling() {
    ...
    let workspace = create_unique_tmp_dir("autter-bare-repo-test").unwrap();
...
fn test_duplicate_files_same_repo() {
    ...
    let workspace = create_unique_tmp_dir("autter-duplicate-test").unwrap();
...
fn test_find_repository_for_file_no_repo_found() {
    ...
    let workspace = create_unique_tmp_dir("autter-no-repo-test").unwrap();
...
fn test_find_repository_for_file_respects_workspace_boundary() {
    ...
    let parent_repo = create_unique_tmp_dir("autter-parent-repo-test").unwrap();
...
fn test_group_files_by_repository() {
    // Create a workspace directory (not a git repo)
    let workspace = create_unique_tmp_dir("autter-group-files-test").unwrap();
...
fn test_find_repository_for_file_nested_repos() {
    ...
    let workspace = create_unique_tmp_dir("autter-nested-repos-test").unwrap();
...
fn test_find_repository_in_path_still_works() {
    ...
    let repo = create_unique_tmp_dir("autter-single-repo-test").unwrap();
    init_git_repo(&repo).unwrap();
...
fn test_find_repository_for_directory() {
    ...
    let workspace = create_unique_tmp_dir("autter-dir-test").unwrap();
...
fn test_cross_repo_edits_grouping() {
    ...
    let workspace = create_unique_tmp_dir("autter-cross-repo-test").unwrap();
...
fn test_workspace_relative_paths() {
    ...
    let workspace = create_unique_tmp_dir("autter-relative-path-test").unwrap();
...
fn test_deeply_nested_file_detection() {
    ...
    let workspace = create_unique_tmp_dir("autter-deep-nest-test").unwrap();
...
fn test_mixed_absolute_and_relative_grouping() {
    ...
    let workspace = create_unique_tmp_dir("autter-mixed-paths-test").unwrap();
...
fn test_repository_isolation() {
    ...
    let workspace = create_unique_tmp_dir("autter-isolation-test").unwrap();
