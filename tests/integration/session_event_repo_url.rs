...
use autter::metrics::{EventAttributes, MetricEvent, PosEncoded, SessionEventValues};
use autter::repo_url::resolve_repo_url_from_path;
use autter::streams::agent::Agent;
use autter::streams::agents::ClaudeAgent;
use autter::streams::watermark::ByteOffsetWatermark;
use autter::streams::{StreamRecord, StreamsDatabase};
use serde_json::json;
use std::fs;
...
fn test_cursor_infer_cwd_returns_none() {
    use autter::streams::agents::CursorAgent;
...
fn test_copilot_infer_cwd_returns_none() {
    use autter::streams::agents::CopilotAgent;
