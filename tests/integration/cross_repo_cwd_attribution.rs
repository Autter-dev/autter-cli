...
fn test_cwd_is_parent_dir_above_repos_single_repo() {
    ...
    let workspace = create_unique_workspace("autter-cwd-parent-test");
...
fn test_cwd_is_parent_dir_above_multiple_repos() {
    let workspace = create_unique_workspace("autter-cwd-parent-multi-test");
...
fn test_cwd_parent_dir_edits_in_repo_subpaths() {
    let workspace = create_unique_workspace("autter-cwd-parent-subpaths-test");
...
fn test_cwd_parent_dir_multiple_files_per_repo_subpaths() {
    let workspace = create_unique_workspace("autter-cwd-parent-multi-files-test");
...
fn test_parent_cwd_blame_correct_across_repos() {
    let workspace = create_unique_workspace("autter-parent-blame-test");
...
fn test_claude_preset_cross_repo_cwd_records_prompts_in_target_repo() {
    ...
    repo_target.patch_autter_config(|patch| {
...
fn test_nested_subrepo_single_file_mock_ai() {
    let workspace = create_unique_workspace("autter-nested-subrepo-test");
...
fn test_nested_subrepo_mixed_edits_mock_ai() {
    let workspace = create_unique_workspace("autter-nested-mixed-test");
...
fn test_nested_multiple_subrepos_mock_ai() {
    let workspace = create_unique_workspace("autter-nested-multi-sub-test");
...
fn test_nested_subrepo_blame_attribution_mock_ai() {
    let workspace = create_unique_workspace("autter-nested-blame-test");
...
fn test_claude_preset_nested_subrepo_records_prompts() {
    let workspace = create_unique_workspace("autter-claude-nested-test");
    ...
    subrepo.patch_autter_config(|patch| {
        patch.exclude_prompts_in_repositories = Some(vec![]);
    });
...
fn test_claude_preset_nested_subrepo_pre_post_cycle() {
    let workspace = create_unique_workspace("autter-claude-nested-cycle-test");
...
fn test_issue_954_non_git_cwd_unrelated_to_target_repo_mock_ai() {
    ...
    let cwd_workspace = create_unique_workspace("autter-954-non-git-cwd");
...
fn test_issue_954_non_git_cwd_multiple_target_repos() {
    let cwd_workspace = create_unique_workspace("autter-954-multi-target-cwd");
...
fn test_issue_954_claude_preset_non_git_cwd() {
    let cwd_workspace = create_unique_workspace("autter-954-claude-cwd");
    let mut repo_target = TestRepo::new();
