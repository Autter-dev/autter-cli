...
use autter::authorship::authorship_log::HumanRecord;
use autter::daemon::{RecentWorkingLogSnapshot, restore_recent_working_log_snapshot};
...
fn recent_working_log_snapshot_preserves_humans_on_restore() {
    ...
    let restored =
        restore_recent_working_log_snapshot(&autter_repo, base_commit, &snapshot).unwrap();
