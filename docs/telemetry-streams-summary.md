...
sqlite3 ~/.autter/transcripts.db "SELECT * FROM sessions;"

# Check watermark for session
sqlite3 ~/.autter/transcripts.db "SELECT session_id, watermark_value FROM sessions WHERE session_id = 'YOUR_SESSION_ID';"

# Check processing stats
sqlite3 ~/.autter/transcripts.db "SELECT * FROM processing_stats WHERE session_id = 'YOUR_SESSION_ID';"

# View metrics events with session_id
sqlite3 ~/.autter/metrics.db "SELECT * FROM events WHERE session_id = 'YOUR_SESSION_ID';"
```
