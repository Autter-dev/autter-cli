...
- [ ] Implement internal_db migration: read prompts from ~/.autter/internal.db, create session records in transcripts.db for known transcripts, rename to internal.db.deprecated
...
- [ ] Test migration: create ~/.autter/internal.db with test data, start daemon, verify migration runs and renames to internal.db.deprecated
