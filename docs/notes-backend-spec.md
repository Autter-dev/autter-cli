...
`https://app.example.com/api/autter`, the requests issued are
`POST https://app.example.com/api/autter/worker/notes/upload` and
`GET  https://app.example.com/api/autter/worker/notes/?commits=...`.
