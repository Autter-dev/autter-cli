...
pub mod attr_pos {
    pub const AUTTER_VERSION: usize = 0;
...
pub struct EventAttributes {
    pub autter_version: PosField<String>,
...
impl EventAttributes {
    ...
    /// Create with required autter_version field set.
    pub fn with_version(version: impl Into<String>) -> Self {
        Self {
            autter_version: Some(Some(version.into())),
            ..Default::default()
        }
    }

    // Builder methods for autter_version
    #[allow(dead_code)]
    pub fn autter_version(mut self, value: impl Into<String>) -> Self {
        self.autter_version = Some(Some(value.into()));
        self
    }

    #[allow(dead_code)]
    pub fn autter_version_null(mut self) -> Self {
        self.autter_version = Some(None);
        self
    }
...
impl PosEncoded for EventAttributes {
    fn to_sparse(&self) -> SparseArray {
        ...
        sparse_set(
            &mut map,
            attr_pos::AUTTER_VERSION,
            string_to_json(&self.autter_version),
        );
    ...
    fn from_sparse(arr: &SparseArray) -> Self {
        Self {
            autter_version: sparse_get_string(arr, attr_pos::AUTTER_VERSION),
...
mod tests {
    ...
    fn test_event_attributes_builder() {
        ...
        assert_eq!(attrs.autter_version, Some(Some("1.0.0".to_string())));
        assert_eq!(
            attrs.repo_url,
    ...
    fn test_event_attributes_from_sparse() {
        ...
        assert_eq!(attrs.autter_version, Some(Some("2.0.0".to_string())));
    ...
    fn test_event_attributes_all_fields() {
        ...
        assert_eq!(attrs.autter_version, Some(Some("1.2.3".to_string())));
        assert_eq!(
            attrs.repo_url,
            Some(Some("https://github.com/user/repo".to_string()))
        );
    ...
    fn test_event_attributes_all_nulls() {
        ...
        assert_eq!(attrs.autter_version, Some(None));
    ...
    fn test_event_attributes_roundtrip() {
        ...
        assert_eq!(restored.autter_version, Some(Some("2.5.0".to_string())));
        assert_eq!(
            restored.repo_url,
    ...
    fn test_event_attributes_partial_sparse() {
        ...
        assert_eq!(attrs.autter_version, Some(Some("3.0.0".to_string())));
    ...
    fn test_event_attributes_default() {
        ...
        assert_eq!(attrs.autter_version, None);
    ...
    #[test]
    fn test_event_attributes_autter_version_builder() {
        let attrs = EventAttributes::new().autter_version("4.0.0");
        assert_eq!(attrs.autter_version, Some(Some("4.0.0".to_string())));
    }
