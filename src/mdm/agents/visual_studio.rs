...
const VSIX_IDENTITY_ID: &str = "AutterVS.A1B2C3D4-E5F6-7890-ABCD-EF1234567890";
...
const MARKETPLACE_URL: &str =
    "https://marketplace.visualstudio.com/items?itemName=autter.autter-visualstudio";
...
/// Check if the autter extension is installed in a VS instance.
...
fn install_vsix(inst: &VsInstallation) -> Result<bool, AutterError> {
...
mod tests {
    ...
    fn test_manifest_declares_vsix_identity() {
        let manifest = r#"
            <PackageManifest>
              <Metadata>
                <Identity Id="AutterVS.A1B2C3D4-E5F6-7890-ABCD-EF1234567890" Version="0.1.0" />
              </Metadata>
            </PackageManifest>
        "#;
    ...
    fn test_manifest_declares_vsix_identity_with_single_quotes_and_spaces() {
        let manifest = r#"
            <PackageManifest>
              <Metadata>
                <Identity Version='0.1.0' Id = 'AutterVS.A1B2C3D4-E5F6-7890-ABCD-EF1234567890' />
              </Metadata>
            </PackageManifest>
        "#;
    ...
    fn test_manifest_rejects_marketplace_item_name_only() {
        let manifest = r#"
            <PackageManifest>
              <Metadata>
                <Identity Id="autter.autter-visualstudio" Version="0.1.0" />
              </Metadata>
            </PackageManifest>
        "#;
    ...
    #[test]
    fn test_manifest_rejects_unrelated_autter_vs_content() {
        let manifest = r#"
            <PackageManifest>
              <Metadata>
                <Identity Id="Other.Extension" Version="0.1.0" />
                <DisplayName>AutterVS helper</DisplayName>
              </Metadata>
            </PackageManifest>
        "#;
