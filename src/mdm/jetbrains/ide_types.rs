...
/// Plugin ID for the Autter IntelliJ plugin
pub const PLUGIN_ID: &str = "com.useautter.plugins.jetbrains";

/// JetBrains Marketplace URL for manual installation
pub const MARKETPLACE_URL: &str =
    "https://plugins.jetbrains.com/plugin/com.useautter.plugins.jetbrains";
