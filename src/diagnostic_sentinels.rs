...
pub const DEBUG_SELF_CHECK_REMOTE_URL: &str = "https://autter.invalid/debug/self-check.git";
pub const DEBUG_SELF_CHECK_NORMALIZED_REMOTE_URL: &str = "https://autter.invalid/debug/self-check";
...
mod tests {
    ...
    fn test_is_debug_self_check_remote_url_matches_raw_and_normalized() {
        assert!(is_debug_self_check_remote_url(
            "https://autter.invalid/debug/self-check.git"
        ));
        assert!(is_debug_self_check_remote_url(
            "https://autter.invalid/debug/self-check"
        ));
        assert!(!is_debug_self_check_remote_url(
