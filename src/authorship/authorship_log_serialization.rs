...
pub const AUTTER_VERSION: &str = "development";

#[cfg(all(debug_assertions, not(test)))]
pub const AUTTER_VERSION: &str = concat!("development:", env!("CARGO_PKG_VERSION"));

#[cfg(not(debug_assertions))]
pub const AUTTER_VERSION: &str = env!("CARGO_PKG_VERSION");
...
///
/// Lines with no attestation entry are "unknown" — not tracked by autter.
