...
## Goal
Prevent `autter` from consuming runaway memory and long wall-clock time in heavy real-world sessions (long history, many files, large transcripts), while keeping checkpoint behavior correct.
...
## Scope
- In scope:
  - checkpoint path performance and memory (`autter checkpoint`, commit pre-hook/post-hook code paths).
...
- `/Users/svarlamov/projects/autter/src/git/repo_storage.rs`
...
- `/Users/svarlamov/projects/autter/src/commands/checkpoint.rs`
...
- `/Users/svarlamov/projects/autter/src/commands/checkpoint_agent/agent_presets.rs`
...
### Repro harness
- Use `/Users/svarlamov/projects/autter/scripts/repro_runaway_memory.py`.
