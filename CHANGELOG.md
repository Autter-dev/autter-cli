...
- **npm distribution**: `npm install -g autter` (and `npx autter`) now works via a thin bootstrapper package that downloads the checksum-verified release binary into `~/.autter/bin`, published automatically by the release workflow.
