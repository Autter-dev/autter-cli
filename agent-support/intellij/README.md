...
<!-- Plugin description -->
**Autter** tracks code generated by AI coding agents in your JetBrains IDE.

When AI agents like GitHub Copilot make edits, Autter automatically records which lines were AI-generated along with the agent and model that wrote them. On commit, this attribution data is saved to Git Notes, enabling:
...
Requires the [autter CLI](https://github.com/autter-dev/autter-cli) to be installed. Learn more at [autter.dev](https://autter.dev).
